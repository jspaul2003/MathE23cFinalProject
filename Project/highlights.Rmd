...
### Testing Data
COVID-19 Testing data was downloaded from ourworldindata^[https://ourworldindata.org/grapher/full-list-total-tests-for-covid-19]. This was cumulative number of tests for each country available on a date basis.
...
The Poisson model did not fare better, with near identical results. The best model found was defined as $Total Deaths= Active Cases*0.17*P(X\leq Day)$ where $X\sim Binom(k, Death Rate)$ and $Day$ is days since 2020-01-22. The plot of this model is shown below.
```{r, results='hide', include=FALSE}
...
![](images/m1b.png){#id .class width=30% height=30%}
...
![](images/m2b.png){#id .class width=30% height=30%}
