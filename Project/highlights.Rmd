...
Death rate is actually not strongly correlated much at all with the other variables. Interestingly, we dont see high degrees of  similarity. Perhaps this indicates that deathrate is relatively constant and hard to model. This indicates challenges for topic 3.
